    ...
    <section id="blog" className="py-28 border-t border-border">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex items-end justify-between mb-12">
          <div>
            <div className="text-[9px] tracking-[3px] text-cyan uppercase mb-2">// 04 — Writing</div>
        ...
        {posts.length === 0 ? (
          <div className="text-[11px] text-muted border border-border p-10 text-center font-mono">
            ...
            <span className="mt-2 block text-dim">No posts yet — coming soon...</span>
          </div>
        ) : (
          <div className="grid md:grid-cols-3 gap-4">
            {posts.map((post) => (
              ...
              >
                <div className="text-[9px] text-muted tracking-wide">{post.date}</div>
                ...
                <p className="text-[10px] text-muted leading-relaxed flex-1">{post.excerpt}</p>
                <div className="flex items-center justify-between">
                  <span className="text-[9px] text-muted">{post.readingTime}</span>
        ...
        <div className="mt-6 md:hidden">
          <Link href="/blog" className="text-[9px] tracking-[2px] text-cyan uppercase">
            All Posts →
          </Link>
        </div>
